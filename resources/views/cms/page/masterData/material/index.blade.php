...
<div class="section-body">
    <ul class="breadcrumb breadcrumb-style ">
        <li class="breadcrumb-item">
            <h4 class="page-title m-b-0">Data Matrial</h4>
        </li>
        <li class="breadcrumb-item">
            <a href="#">
        ...
        <li class="breadcrumb-item">Data Matrial</li>
    </ul>
    <div class="row">
        <div class="col-12">
            ...
            <div class="card" id="card-form">
                <div class="card-header">
                    <h4>Tambah Matrial</h4>
                </div>

                <div class="buttons">
                    <a href="#" class="btn pull-right btn-icon icon-left btn-primary"
                        style="margin-top: 5px; margin-bottom: 10px" id="tambah-material"><i
                ...
                <div class="card-body">
                    @include('cms.page.form.material')
                </div>
            </div>
            <div class="card" id="card-tabel">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped  dt-responsive nowrap" id="materialTable" cellspacing="0"
                            style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>
...
@include('cms.page.modals.material.edit')
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#data-master').on('submit', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "{{url('cms/material/createOrUpdate')}}",
                data: datax,
                dataType: "json",
                cache: false,
                contentType: false,
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        let oTable = $('#materialTable').dataTable();
                        oTable.fnDraw(false);
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Menambah Matrial !',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Menambah Matrial !'
                        })
                    } else if (response.status == 3) {
                        Toast.fire({
                            icon: 'warning',
                            title: 'Matrial Telah Tersedia !'
                        })
                    }
                },
                error: function (e) {
        ...
        $(this).on('click', '#button_delete', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "GET",
                        url: `{{url('cms/material/delete')}}/${id}`,
                        data: {
                            _token: '{{csrf_token()}}'
                        },
                        dataType: "json",
                        success: function (response) {
                            if (response.status == 1) {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: 'Berhasil Menghapus Matrial !',
                                });
                            } else if (response.status == 2) {
                                Toast.fire({
                                    icon: 'error',
                                    title: 'Gagal Menghapus Matrial !'
                                })
                            }
                        },
                        error: function () {
        ...
        $(this).on('click', "#button_edit", function (e) {
            ...
            $(".modal-title").html("Ubah Data Matrial");
        });
                ...
                success: function (response) {
                    ...
                    if (response.status == 1) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Berhasil Memperbaharui Matrial!',
                        });
                    } else if (response.status == 2) {
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Memperbaharui Matrial !'
                        })
                    }
                },
                error: function (e) {
