 <!-- Modal with form -->
 <div class="modal fade" id="editProduct" tabindex="-1" role="dialog" aria-labelledby="formModal"
 aria-hidden="true">
     ...
     <div class="modal-body">
        <form method="post" id="data-edit"  enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="summernote" name="description" id="description_edit"></textarea>
              </div>
